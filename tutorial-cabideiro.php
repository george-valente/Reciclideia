                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="titlepage text_align_left">
                                <h2>Cabideiro utilizando <span>cabos de vassoura</span></h2>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="about_text text_align_left">
                                ...
                                <ul>
                                    <li>Tesoura;</li>
                                    <li>4 cabos de vasssoura;</li>
                                    <li>Cordão de couro;</li>
                                    <li>Tinta (opcional);</li>
                                </ul>
                                </br>
                                <h2>Passo a passo</h2>
                                </br>
                                ...
                                <ol>
                                    <li>* Pinte os cabos se desejar *</li>
                                    <li>Cruze os cabos e faça com que cada pé fique em cada ponta, de forma que tenha equilíbrio</li>
                                    <li>Quando conseguir equilibrar os cabos, amarre o meio dos cabos com o cordão de couro, amarre de forma firme</li>
                                    <li>Esconda as pontas da amarração</li>
                                    <li>Faça estes dois passos com auxílio da cola quente</li>
                                    <li>Ajuste os ângulos e deixe bem alinhado no chão </li>
                                    <li>E está pronto!</li>
                                </ol>
                                </br>
                        ...
                        <div class="col-lg-4">
                            <div class="about_img">
                                <figure><img class="img_responsive" src="images/cabideiro-vassouras.jpg" alt="#" /></figure>
                            </div>
                        </div>
                    </div>
                </div>
